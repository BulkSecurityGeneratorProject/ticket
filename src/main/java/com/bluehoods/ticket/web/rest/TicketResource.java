...
import com.bluehoods.ticket.service.TicketService;
...
public class TicketResource {
    ...
    @Timed
    public ResponseEntity<List<TicketDTO>> searchTickets(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/tickets");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
