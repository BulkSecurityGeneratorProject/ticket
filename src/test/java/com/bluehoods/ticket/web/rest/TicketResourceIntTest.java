...
public class TicketResourceIntTest {
    ...
    private static final String DEFAULT_TICKET_DESC = "AAAAAAAAAA";
    private static final String UPDATED_TICKET_DESC = "BBBBBBBBBB";
    ...
    public static Ticket createEntity(EntityManager em) {
        Ticket ticket = new Ticket()
            ...
            .ticket_desc(DEFAULT_TICKET_DESC)
            .type(DEFAULT_TYPE)
    ...
    public void createTicket() throws Exception {
        ...
        assertThat(testTicket.getTicket_name()).isEqualTo(DEFAULT_TICKET_NAME);
        assertThat(testTicket.getTicket_desc()).isEqualTo(DEFAULT_TICKET_DESC);
        ...
        assertThat(ticketEs).isEqualToIgnoringGivenFields(testTicket);
    }
    ...
    public void getAllTickets() throws Exception {
        ...
        restTicketMockMvc.perform(get("/api/tickets?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ticket_name").value(hasItem(DEFAULT_TICKET_NAME.toString())))
            .andExpect(jsonPath("$.[*].ticket_desc").value(hasItem(DEFAULT_TICKET_DESC.toString())))
    ...
    public void getTicket() throws Exception {
        ...
        restTicketMockMvc.perform(get("/api/tickets/{id}", ticket.getId()))
            ...
            .andExpect(jsonPath("$.ticket_name").value(DEFAULT_TICKET_NAME.toString()))
            .andExpect(jsonPath("$.ticket_desc").value(DEFAULT_TICKET_DESC.toString()))
    ...
    public void updateTicket() throws Exception {
        ...
        updatedTicket
            .ticket_name(UPDATED_TICKET_NAME)
            .ticket_desc(UPDATED_TICKET_DESC)
            .type(UPDATED_TYPE)
        ...
        Ticket testTicket = ticketList.get(ticketList.size() - 1);
        assertThat(testTicket.getTicket_name()).isEqualTo(UPDATED_TICKET_NAME);
        assertThat(testTicket.getTicket_desc()).isEqualTo(UPDATED_TICKET_DESC);
